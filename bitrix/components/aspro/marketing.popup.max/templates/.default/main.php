				...
				<div class="popup-text-info__text font_sm">
					...
					<?if($bBtn1 || $bBtn2):?>
						...
						<div class="popup-text-info__btn">
							<?if($bBtn1):?>
								<a class="btn <?=($arResult['ITEM']['PROPERTY_BTN1_CLASS_VALUE'] ? $arResult['ITEM']['PROPERTY_BTN1_CLASS_VALUE'] : "btn-default");?> btn-lg" href="<?=SITE_DIR?><?=$arResult['ITEM']["PROPERTY_BTN1_LINK_VALUE"];?>"><?=$arResult['ITEM']['PROPERTY_BTN1_TEXT_VALUE'];?></a>
							<?endif;?>
							<?if($bBtn2):?>
								<a class="btn <?=($arResult['ITEM']['PROPERTY_BTN2_CLASS_VALUE'] ? $arResult['ITEM']['PROPERTY_BTN2_CLASS_VALUE'] : "btn-transparent-border-color");?> btn-lg" href="<?=SITE_DIR?><?=$arResult['ITEM']["PROPERTY_BTN2_LINK_VALUE"];?>"><?=$arResult['ITEM']['PROPERTY_BTN2_TEXT_VALUE'];?></a>
							<?endif;?>
						</div>
					<?endif;?>
				</div>
