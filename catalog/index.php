...
$APPLICATION->SetPageProperty("title", "Каталог товаров | Перекрёсток");
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_BLOCKS_TAB_ORDER" => "desc,stores,video,reviews,buy,payment,delivery,custom_tab,char",
		"DETAIL_BLOCKS_ALL_ORDER" => "complect,goods,nabor,offers,desc,buy,payment,delivery,video,stores,custom_tab,services,news,blog,reviews,staff,vacancy,gifts,char",
		"DELIVERY_CALC" => "Y",
		"DELIVERY_CALC_NAME" => "",
		"ASK_TAB" => "",
		"TAB_NEWS_NAME" => "",
...
<h2><span style="color: #acacac; font-size: 11pt;">Фото может не соответствовать реальному виду товара, уточняйте у продавца</span></h2>
